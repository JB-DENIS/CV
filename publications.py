...
def publis_page():
    ...
    st.markdown(
        "<h6 style='text-align: center; color: gray;'>Cliquez sur un lien pour accéder au contenu</h5>",
    ...
    col5.image("img/publi_brevet.jpg", use_container_width=True)
    col7.image("img/publi_poster.jpg", use_container_width=True)
    col9.image("img/publi_these.jpg", use_container_width=True)
    ...
    col2.image("img/publi_prix.jpg", use_container_width=True)  # width=220)
    col2.write(pr)
