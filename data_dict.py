...
TOOLS_DICT = {
    "Python": 8,
    "Data (Pandas, Numpy, Polar, Scipy, PySpark, ...)": 8,
    "Machine learning (Scikit Learn, LightGBM, XGBoost, ...)": 8,
    "Deep learning (TensorFlow, Keras, PyTorch, ...)": 7,
    "Data Viz (Matplotlib, Plotly, Seaborn, Grafana, Streamlit, ...)": 8,
    "Computer Vision - NLP (OpenCV, Pillow, Tesseract, Spacy, nltk, Hugging Face, ...)": 7,
    "IA générative (LangChain, LlamaIndex, OpenAI API, ChatGPT, ...)": 8,
    "Audio (Tortoise, Whisper, Coqui, ...)": 6,
    "Monitoring et Observabilité (Grafana, Kibana, Prometheus, ...)": 7,
    "DataBase (SQLite, PostgreSQL, MySQL, Cassandra, Redis, Elasticsearch)": 6,
    "Vectorielles (ChromaDB, Faiss, Qdrant, ...)": 7,
    "Dev (FastAPI, Flask, Pydantic, SQLAlchemy, MLflow, Airflow, ...)": 7,
    "Ops (Docker, Kubernetes, AWS (S3, EC2), Terraform, Jenkins, ArgoCD, ...)": 5,
    "Outils (Git, GitLab, GitHub Actions, VsCode, Jupyter Notebook, ...)": 8,
    "Env (Windows, Unix, WSL2)": 7,
