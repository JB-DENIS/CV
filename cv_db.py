...
st.set_page_config(page_title='CV JB DENIS',
                   layout="wide", page_icon=icone_img)
...
def page_accueille():
    ...
    col4, col5, col6, col7, col8 = st.beta_columns(
        (3, 0.00000001, 1.1, 0.2, 1.4))
...
def page_experience():
    ...
    st.text('')
    st.text('')
    st.markdown("<h5 style='text-align: center; color: gray;'>Choisissez une catégorie</h5>",
                unsafe_allow_html=True)
    st.text('')
    ...
    col4, col5, col6, col7, col8, col9 = st.beta_columns(
        (0.5, 1, 0.5, 1, 0.5, 1))  # ((0.5,1,0.35,1,0.45,1))
    ...
    if bouton1:
        ...
        col17.write(
            '**_Classification automatique de biens de consommation_** ')
    ...
    if bouton2:
        ...
        col15, col16 = st.beta_columns((1, 1))
        col15.write(
            '**_Développement et amélioration du procédé de production _** ')
        col16.write(
            '**_Gestion de projets / Management d’équipe technique _** ')

        st.text('')
        col17, col18 = st.beta_columns((1, 1))
        col17.write('**_Entrepreneuriat_** ')
        col18.write(
            '**_Etude de marché et profils clients (Datas BPI France)_** ')
        ...
        st.write(
            ':black_small_square: Conception et mise en place d’outils techniques')
        ...
        col18.write(
            '**_Conception bancs essai et outils techniques, maintenance_** ')
    ...
    if bouton3:
        ...
        st.write(
            ':black_small_square: Mise à niveau électrique – circuit de plomberie')
...
def page_media():
    ...
    st.markdown("<h5 style='text-align: center; color: gray;'>Cliquez sur un média pour accéder au contenu</h5>",
                unsafe_allow_html=True)
    st.text('')
    st.text('')
...
def page_publi():
    ...
    st.markdown("<h5 style='text-align: center; color: gray;'>Cliquez sur un lien pour accéder au contenu</h5>",
                unsafe_allow_html=True)
    st.text('')
    st.text('')
