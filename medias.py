...
def medias_page():
    ...
    st.markdown(
        "<h6 style='text-align: center; color: gray;'>Cliquez sur un média pour accéder au contenu</h5>",
    ...
    st.text("")
    st.markdown(
        "<h6 style='text-align: center; color: gray;'>Attention, le son est automatiquement au maximum</h5>",
        unsafe_allow_html=True,
    )
    st.video(media_yt)
